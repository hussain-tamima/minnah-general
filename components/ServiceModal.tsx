...
export function ServiceModal({ service, onClose }: Props) {
  ...
  return (
    <div className="service-modal" role="dialog" aria-modal="true" aria-labelledby="service-modal-title">
      <button type="button" className="service-modal__backdrop" aria-label="Close" onClick={onClose} />
      <div className="service-modal__panel">
        <button type="button" className="service-modal__close" aria-label="Close" onClick={onClose}>
          ×
        </button>
        <div className="service-modal__image">
          <Image src={service.image} alt={service.title} fill sizes="(max-width: 768px) 100vw, 560px" priority />
        </div>
        <div className="service-modal__body">
          ...
          <div className="service-modal__actions">
            ...
            <button type="button" className="btn btn--dark-outline" onClick={onClose}>
              Close
            </button>
          </div>
        </div>
